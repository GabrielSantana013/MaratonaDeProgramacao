...
No entanto, quando Péricles clicou sem querer em uma das propagandas de uma aba, percebeu que, 
...
Cada linha subsequente contém uma ação (fechou ou clicou). 
